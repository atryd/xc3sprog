...
bool IOSolas::txrx(bool tms, bool tdi)
{
  int tdo;
...
void IOSolas::tx(bool tms, bool tdi)
{
  fprintf(stderr, "tx(%d,%d)\n",tms,tdi);
  
}

void IOSolas::tx_tdi_byte(unsigned char tdi_byte) {
}
void IOSolas::txrx_block(const unsigned char *tdi, unsigned char *tdo,
...
void IOSolas::tx_tms(unsigned char *pat, int length, int force)
{
    int i;
